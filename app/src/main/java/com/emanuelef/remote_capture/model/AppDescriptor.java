...
public class AppDescriptor implements Comparable<AppDescriptor>, Serializable {
    ...
    public @Nullable Drawable getIcon() {
        ...
        if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) && CaptureService.isCapturingAsRoot()) {
            ...
            if (!badgedIconFails) {
                try {
                    ...
                    AppLogger.w(TAG, "getUserBadgedIcon failed, using icons without badges: " + e.getMessage());
        ...
        //AppLogger.d("Icon size", mIcon.getIntrinsicWidth() + "x" + mIcon.getIntrinsicHeight());
