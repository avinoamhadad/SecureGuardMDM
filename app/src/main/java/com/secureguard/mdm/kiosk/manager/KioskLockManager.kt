...
class KioskLockManager @Inject constructor(
    ...
    fun rebootDevice() {
        if (!dpm.isDeviceOwnerApp(context.packageName)) {
            ...
            Toast.makeText(context, context.getString(R.string.kiosk_error_not_device_owner), Toast.LENGTH_LONG).show()
            return
        }
        ...
        try {
            ...
            Toast.makeText(context, context.getString(R.string.kiosk_error_reboot_failed, e.message), Toast.LENGTH_SHORT).show()
        }
    }
}
