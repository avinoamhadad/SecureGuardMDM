...
data class KioskManagementState(
    ...
    val isSingleWebsiteKioskEnabled: Boolean = false,
    val singleWebsiteUrl: String = "",
...
class KioskManagementViewModel @Inject constructor(
        ...
        viewModelScope.launch {
            ...
            _uiState.update {
                it.copy(
                    ...
                    isSingleWebsiteKioskEnabled = isSingleEnabled,
                    singleWebsiteUrl = singleUrl,
    ...
    fun setSingleWebsiteKioskEnabled(enabled: Boolean) {
        viewModelScope.launch {
            settingsRepository.setSingleWebsiteKioskEnabled(enabled)
            _uiState.update { it.copy(isSingleWebsiteKioskEnabled = enabled) }
        }
    }

    fun setSingleWebsiteKioskUrl(url: String) {
        viewModelScope.launch {
            settingsRepository.setSingleWebsiteKioskUrl(url)
            _uiState.update { it.copy(singleWebsiteUrl = url) }
        }
    }
