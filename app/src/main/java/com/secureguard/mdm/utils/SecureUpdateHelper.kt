...
class SecureUpdateHelper @Inject constructor(
    ...
    private fun getAppSignatureSha256(context: Context): String? {
        try {
            ...
            AppLogger.e("SignatureCheck", "Failed to get app signature hash", e)
        }
        return null
    }
    ...
    fun verifyLocalApkSignature(localApkPath: String): Boolean {
        ...
        // } catch (e: Exception) {
        //     AppLogger.e("SecureUpdateHelper", "Signature verification for local APK failed", e)
        //     return false
        // }
    ...
    fun verifyUpdate(apkUri: Uri): UpdateVerificationResult {
        ...
        try {
            ...
            AppLogger.e("SecureUpdateHelper", "Verification failed", e)
