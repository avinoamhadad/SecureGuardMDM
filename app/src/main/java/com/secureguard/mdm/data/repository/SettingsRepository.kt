...
interface SettingsRepository {
    ...
    suspend fun isSingleWebsiteKioskEnabled(): Boolean
    suspend fun setSingleWebsiteKioskEnabled(isEnabled: Boolean)
    suspend fun getSingleWebsiteKioskUrl(): String
    suspend fun setSingleWebsiteKioskUrl(url: String)
    ...
    fun getAstoreEnabledFlow(): Flow<Boolean>

    // --- Astore Settings ---
    suspend fun isAstoreEnabled(): Boolean
    suspend fun setAstoreEnabled(isEnabled: Boolean)
    suspend fun isAstoreFirstTimeSetup(): Boolean
    suspend fun setAstoreFirstTimeSetup(isFirstTime: Boolean)
    suspend fun getAstoreCustomPackages(): Set<String>
    suspend fun setAstoreCustomPackages(packageNames: Set<String>)

    // --- Astore Advanced Settings ---
    suspend fun getAstoreSaveToDownloads(): Boolean
    suspend fun setAstoreSaveToDownloads(enabled: Boolean)
    suspend fun getAstoreAutoInstall(): Boolean
    suspend fun setAstoreAutoInstall(enabled: Boolean)
    suspend fun getAstorePreventDoubleTap(): Boolean
    suspend fun setAstorePreventDoubleTap(enabled: Boolean)
}
