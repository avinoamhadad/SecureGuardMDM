...
class SettingsRepositoryImpl @Inject constructor(
    ...
    override suspend fun isSingleWebsiteKioskEnabled(): Boolean = withContext(Dispatchers.IO) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_KIOSK_SINGLE_WEBSITE_ENABLED, false)
    }

    override suspend fun setSingleWebsiteKioskEnabled(isEnabled: Boolean) = withContext(Dispatchers.IO) {
        preferencesManager.saveBoolean(PreferencesManager.KEY_KIOSK_SINGLE_WEBSITE_ENABLED, isEnabled)
    }

    override suspend fun getSingleWebsiteKioskUrl(): String = withContext(Dispatchers.IO) {
        preferencesManager.loadString(PreferencesManager.KEY_KIOSK_SINGLE_WEBSITE_URL, "") ?: ""
    }

    override suspend fun setSingleWebsiteKioskUrl(url: String) = withContext(Dispatchers.IO) {
        preferencesManager.saveString(PreferencesManager.KEY_KIOSK_SINGLE_WEBSITE_URL, url)
    }
    ...
    override fun getAstoreEnabledFlow(): Flow<Boolean> = preferenceFlow(PreferencesManager.KEY_ASTORE_ENABLED) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_ASTORE_ENABLED, false)
    }

    // --- Astore Settings Implementation ---
    override suspend fun isAstoreEnabled(): Boolean = withContext(Dispatchers.IO) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_ASTORE_ENABLED, false)
    }

    override suspend fun setAstoreEnabled(isEnabled: Boolean) = withContext(Dispatchers.IO) {
        preferencesManager.saveBoolean(PreferencesManager.KEY_ASTORE_ENABLED, isEnabled)
    }

    override suspend fun isAstoreFirstTimeSetup(): Boolean = withContext(Dispatchers.IO) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_ASTORE_FIRST_TIME_SETUP, true)
    }

    override suspend fun setAstoreFirstTimeSetup(isFirstTime: Boolean) = withContext(Dispatchers.IO) {
        preferencesManager.saveBoolean(PreferencesManager.KEY_ASTORE_FIRST_TIME_SETUP, isFirstTime)
    }

    override suspend fun getAstoreCustomPackages(): Set<String> = withContext(Dispatchers.IO) {
        preferencesManager.loadStringSet(PreferencesManager.KEY_ASTORE_CUSTOM_PACKAGES, emptySet())
    }

    override suspend fun setAstoreCustomPackages(packageNames: Set<String>) = withContext(Dispatchers.IO) {
        preferencesManager.saveStringSet(PreferencesManager.KEY_ASTORE_CUSTOM_PACKAGES, packageNames)
    }

    override suspend fun getAstoreSaveToDownloads(): Boolean = withContext(Dispatchers.IO) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_ASTORE_SAVE_TO_DOWNLOADS, false)
    }

    override suspend fun setAstoreSaveToDownloads(enabled: Boolean) = withContext(Dispatchers.IO) {
        preferencesManager.saveBoolean(PreferencesManager.KEY_ASTORE_SAVE_TO_DOWNLOADS, enabled)
    }

    override suspend fun getAstoreAutoInstall(): Boolean = withContext(Dispatchers.IO) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_ASTORE_AUTO_INSTALL, true)
    }

    override suspend fun setAstoreAutoInstall(enabled: Boolean) = withContext(Dispatchers.IO) {
        preferencesManager.saveBoolean(PreferencesManager.KEY_ASTORE_AUTO_INSTALL, enabled)
    }

    override suspend fun getAstorePreventDoubleTap(): Boolean = withContext(Dispatchers.IO) {
        preferencesManager.loadBoolean(PreferencesManager.KEY_ASTORE_PREVENT_DOUBLE_TAP, true)
    }

    override suspend fun setAstorePreventDoubleTap(enabled: Boolean) = withContext(Dispatchers.IO) {
        preferencesManager.saveBoolean(PreferencesManager.KEY_ASTORE_PREVENT_DOUBLE_TAP, enabled)
    }
